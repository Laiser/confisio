...
scheduler.locale = {
	...
	labels:{
		...
		icon_edit:"Editar",
		icon_delete:"Exluir",
		confirm_closing:"Suas mudanças serão perdidas, você têm certeza ? ",//Your changes will be lost, are your sure ?
		confirm_deleting:"O evento será excluido permanentemente, você têm certeza?", //Event will be deleted permanently, are you sure?
		section_description:"Descrição",
		section_time:"Duração",
